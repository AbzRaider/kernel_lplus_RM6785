...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xEB, 0x17, 0x41, 0x92, 0x0E, 0x10,
		0x82, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
	...
	lcm_dcs_write_seq_static(ctx, 0xE8, 0x10, 0x30);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);

	lcm_dcs_write_seq_static(ctx, 0xFC, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xE3, 0x88);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x07);
	lcm_dcs_write_seq_static(ctx, 0xED, 0x67);
	lcm_dcs_write_seq_static(ctx, 0xFC, 0xA5, 0xA5);
	msleep(60);

	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x08);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x12);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
	lcm_dcs_write_seq_static(ctx, 0x53, 0x20);

	lcm_dcs_write_seq_static(ctx, 0x55, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0xDE);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);

	lcm_dcs_write_seq_static(ctx, 0x81, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x02);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0xE0, 0x03, 0x00, 0x0E, 0xF0,
	0x02, 0x05, 0x0A, 0xFF, 0x18, 0xFE, 0xE0, 0xFF, 0x0C, 0xEC,
	0xF8, 0xF4, 0x02, 0xFF, 0xFF, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x00, 0X00);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);

	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x23);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x91);
	lcm_dcs_write_seq_static(ctx, 0x83, 0x80);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x00, 0xC0);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
...
static int panel_ata_check(struct drm_panel *panel)
{
	...
	unsigned char id[3] = {0xae, 0x31, 0x2};
	ssize_t ret;
