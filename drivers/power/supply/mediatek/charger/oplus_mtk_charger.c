...
#if defined(VENDOR_EDIT) && !defined(CONFIG_OPLUS_CHARGER_MT6370_TYPEC)
/* Jianwei.Ye@BSP.CHG.Basic, 2019/12/119,  delete for charging */
...
/* Jianwei.Ye@BSP.CHG.Basic, 2020/03/03, Modify for otg */
	...
	if (pinfo->tcpc != NULL) {
		chr_err("Found type_c_port0\n");
	} else {
		chr_err("*** Error : can't find type_c_port0 ***\n");
	}
#endif /* VENDOR_EDIT && CONFIG_OPLUS_CHARGER_MT6370_TYPEC */
#if defined(VENDOR_EDIT) && !defined(CONFIG_OPLUS_CHARGER_MT6370_TYPEC)
/* Jianchao.Shi@BSP.CHG.Basic, 2019/06/10, sjc Modify for charging */
...
/* Jianchao.Shi@BSP.CHG.Basic, 2019/06/10, sjc Modify for charging */
	...
	mutex_unlock(&consumer_mutex);
#if defined(VENDOR_EDIT) && !defined(CONFIG_OPLUS_CHARGER_MT6370_TYPEC)
/* Jianwei.Ye@BSP.CHG.Basic, 2019/12/19, sjc Modify for charging */
	info->chg1_consumer =
		charger_manager_get_by_name(&pdev->dev, "charger_port1");
	info->init_done = true;
	_wake_up_charger(info);
