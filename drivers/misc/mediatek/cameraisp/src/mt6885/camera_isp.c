...
static void ISP_DumpRawiR2DebugData(enum ISP_IRQ_TYPE_ENUM module)
{
	...
	//zhongxuejian@CAMERA.DRV, 2020/10/30, add mtk patch for ISP pass1 deque fail
...
static inline void ISP_Reset(int module)
{
	...
	case ISP_CAM_C_IDX: {
		...
		ISP_WR32(CAM_REG_CTL_SW_CTL(module), 0x0);
		//Tanyijun@CAMERA.DRV 2020/11/21, add for resolve monkey isp pass1 deque fail issue
		/* reset FBC */
		ISP_WR32(CAM_REG_FBC_IMGO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_IMGO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_RRZO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_RRZO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_UFEO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_UFEO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_UFGO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_UFGO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_LCESO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_LCESO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_LCESHO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_LCESHO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_AFO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_AFO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_AAO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_AAO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_PDO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_PDO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_TSFSO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_TSFSO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_FLKO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_FLKO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_RSSO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_RSSO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_YUVO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_YUVO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_YUVBO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_YUVBO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_YUVBO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_YUVBO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_YUVCO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_YUVCO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_CRZO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_CRZO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_CRZBO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_CRZBO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_LTMSO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_LTMSO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_AAHO_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_AAHO_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_CRZO_R2_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_CRZO_R2_CTL1(module), 0x0);
		ISP_WR32(CAM_REG_FBC_RSSO_R2_CTL1(module), 0x100);
		ISP_WR32(CAM_REG_FBC_RSSO_R2_CTL1(module), 0x0);
		//Tanyijun@CAMERA.DRV 2020/11/21, add for resolve monkey isp pass1 deque fail issue
		break;
	}
	case ISP_CAMSV0_IDX:
