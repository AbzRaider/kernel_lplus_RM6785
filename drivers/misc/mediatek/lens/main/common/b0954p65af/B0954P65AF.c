...
/*
 * B0954P65AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "B0954P65AF_DRV"
...
#if 0
static int B0954P65AF_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long B0954P65AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int B0954P65AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int B0954P65AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
            int *pAF_Opened)
{
...
int B0954P65AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int B0954P65AF_GetFileName(unsigned char *pFileName)
{
