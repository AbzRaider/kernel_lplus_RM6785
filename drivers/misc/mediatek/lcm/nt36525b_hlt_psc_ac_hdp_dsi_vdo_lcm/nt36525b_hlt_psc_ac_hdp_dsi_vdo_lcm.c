...
static void lcm_get_params(struct LCM_PARAMS *params)
{
    ...
    //Hongwu.Wei@ODM_WT.MM.LCD,2020/04/04, add /proc/devinfo/lcd node
    register_device_proc("lcd", "nt36525b", "hlt_novtek_ac");
}
...
//Jiantao.Liu@ODM_WT.MM.Display.Lcd, 2020/07/06, Add dimming off for power off sequence with tBLOFF
	...
	pr_err("[ HW check ac backlight nt36525b+hlt]level=%d para_list[0]=%x,para_list[1]=%x\n",level,bl_level[0].para_list[0],bl_level[0].para_list[1]);
	MDELAY(5);
...
struct LCM_DRIVER nt36525b_hlt_psc_ac_hdp_dsi_vdo_lcm_drv = {
	.name = "nt36525b_hlt_psc_ac_vdo",
