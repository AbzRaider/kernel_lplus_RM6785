...
static struct imgsensor_info_struct imgsensor_info = {
		...
		.sensor_id = VICTOR_S5K3P9SP_SENSOR_ID,
		#ifdef VENDOR_EDIT
		/*Caohua.Lin@Camera.Driver add for 18011/18311  board 20180723*/
...
static kal_uint16 read_module_id(void)
{
	...
	if (get_byte == 0) {
		iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, 0xA9/*EEPROM_READ_ID*/);
	}
	return get_byte;
...
UINT32 VICTOR_S5K3P9SP_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
