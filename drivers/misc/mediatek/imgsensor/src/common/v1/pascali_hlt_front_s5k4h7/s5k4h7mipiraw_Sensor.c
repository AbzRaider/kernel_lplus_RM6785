...
#define PASCALI_S5K4H7_MODULE_ID 0x931//hlt
#endif
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALI_HLT_FRONT_S5K4H7_SENSOR_ID,	/*S5K4H7_SENSOR_ID = 0x487C */
...
#ifdef S5K4H7_OTP_ENABLE
unsigned char PASCALI_S5K4H7_HLT_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void PASCALI_S5K4H7_HLT_write_cmos_sensor(u16 addr, u32 para)
{
	char pusendcmd[3] = {(char)(addr >> 8), (char)(addr & 0xFF), (char)(para & 0xFF)};
...
static void preview_setting(void)
{
	...
	#ifdef S5K4H7_OTP_ENABLE
	PASCALI_HLT_S5K4H7_OTP_Setting();
	#endif
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = return_sensor_id();
		...
		//} else {
					...
					//printk("s5k4h7 check board fail(pascal a)\n");
		//}
		}
	...
	#ifdef S5K4H7_OTP_ENABLE
	if(PASCALI_S5K4H7_MODULE_ID == PASCALI_HLT_S5K4H7_OTP_CheckID()) {
		*sensor_id = imgsensor_info.sensor_id;
		//hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "Hlt");
	} else {
		PASCALI_HLT_S5K4H7_OTP_Release();
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	#endif
