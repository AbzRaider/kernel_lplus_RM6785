...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .pre = { /* reg_B-11 3280x2464 @30fps*/
        ...
        .mipi_pixel_rate = 268000000,
        .max_framerate = 300, /* 30fps */
    },

    .cap = { /*reg_B-11 32M@30fps*/
        .pclk = 284400000,
        .linelength = 3768,
        .framelength = 2514,
        .startx = 0,
    ...
    .normal_video = { /* reg_k 3264x2448 @30fps*/
        .pclk = 465600000,
        .linelength = 3768,
        .framelength = 4118,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        /* following for GetDefaultFramerateByScenario() */
        .mipi_pixel_rate = 463200000,
        .max_framerate = 300, /* 30fps */
    },

    .hs_video = { /* reg_I 3264*1840@120fps*/
        .pclk = 864000000,
        .linelength = 3768,
        .framelength = 1910,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        /* following for GetDefaultFramerateByScenario() */
        .mipi_pixel_rate = 878400000,
        .max_framerate = 1200, /* 120fps */
    },

    .slim_video = { /* reg_H-3 3264x1840@60fps*/
        .pclk = 456000000,
        .linelength = 3768,
        .framelength = 2016,
        .startx = 0,
    ...
    .custom1 = { /*reg_M-1 1632x1224  @15FPS */
        .pclk = 211200000,
        .linelength = 6262,
        .framelength = 2248,
        .startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
    ...
    {6560, 4928, 0, 624, 6560, 3680, 3280, 1840,  8,   0, 3264, 1840,  0,  0, 3264, 1840}, /* hs_video */
    {6560, 4928, 0, 624, 6560, 3680, 3280, 1840,  8,   0, 3264, 1840,  0,  0, 3264, 1840}, /* slim video */
...
static kal_uint16 imx616_QSC_setting[1560*2];
...
static void read_EepromQSC(void)
{
    ...
    int i = 0;
    for (i = 0; i < 1560; i ++) {
        imx616_QSC_setting[2*i] = sensoraddr_qsc+i;
        imx616_QSC_setting[2*i+1] = Eeprom_1ByteDataRead((addr_qsc+i), 0xA8);
    }
...
static void write_sensor_QSC(void)
{
    ...
    if (Eeprom_1ByteDataRead(0x1418, 0xA8) == 1 && !qsc_flag) {
        imx616_table_write_cmos_sensor(imx616_QSC_setting,
            sizeof(imx616_QSC_setting) / sizeof(kal_uint16));
        qsc_flag = 1;
    }
    LOG_INF("%s end\n", __func__);
}
...
static kal_uint16 imx616_custom4_setting[] = {
/*MIPI output setting*/
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void custom4_setting(void)
{
    LOG_INF("%s start\n", __func__);
    /*************MIPI output setting************/
    imx616_table_write_cmos_sensor(imx616_custom4_setting,
        sizeof(imx616_custom4_setting)/sizeof(kal_uint16));
     LOG_INF("%s end\n", __func__);
}
/*************************************************************************
 * FUNCTION
...
static kal_uint16 imx616_feedback_awbgain[] = {
    0x0b90, 0x00,
    0x0b91, 0x01,
    0x0b92, 0x00,
    0x0b93, 0x01,
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
    ...
    imx616_feedback_awbgain[1] = r_gain_int;
    imx616_feedback_awbgain[3] = (
        ((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
    imx616_feedback_awbgain[5] = b_gain_int;
    imx616_feedback_awbgain[7] = (
        ((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
    imx616_table_write_cmos_sensor(imx616_feedback_awbgain,
        sizeof(imx616_feedback_awbgain)/sizeof(kal_uint16));
}
