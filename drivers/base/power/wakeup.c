...
bool pm_wakeup_pending(void)
{
	...
	//Qiwu.Chen@BSP.Kernel.Stability, 2020/10/13, for maybe pm_abort_suspend happend here
	int counter;
	...
	//Qiwu.Chen@BSP.Kernel.Stability, 2020/10/13, modify for maybe pm_abort_suspend happend here
